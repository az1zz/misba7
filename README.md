...
## دليل الملفات
1. **Misbah_Context_Enhancer** الملف الذي سيساعدك على صنع التعليمات الخاصة بالذكاء الاصطناعي الخاص بك وبتفضيلاتك باستخدام منهجية مصباح
2. **Dynamic COT (PCPSP-v1.0)** هذا الملف سيساعد الذكاء الاصطناعي للإجابة بجودة عالية لأعقد المشكلات
