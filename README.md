...
## دليل الملفات
1. ملف **Misbah_Context_Enhancer**

   الملف الذي سيساعدك على صنع التعليمات الخاصة بالذكاء الاصطناعي الخاص بك وبتفضيلاتك باستخدام منهجية مصباح
   
2. ملف **Dynamic COT (PCPSP-v1.0)**

   هذا الملف سيساعد الذكاء الاصطناعي للإجابة بجودة عالية لأعقد المشكلات

3. ملف **Questions_Generator_Instructions**
  
     هذا الملف يحتوي على تعليمات جاهزة يمكنك إضافتها مباشرة, وتعديلها على حسب تفضيلاتك ورغباتك الى تلقينتك لتحسين مخرجات الذكاء الاصطناعي الذي تستعمله لتوليد الاسئلة

4. ملف **Video_Script_Writer**
  
      هذا الملف يحتوي على تعليمات جاهزة يمكنك اضافتها مباشرة, وتعديلها على حسب تفضيلاتك ورغباتك الى تلقينتك لتحسين مخرجات الذكاء الاصطناعي الذي تستعمله لكتابة محتوى المقاطع او الفيديوهات

5. ملف **GEMINI**

   هذا الملف يحتوي على تعليمات خاصة للمساعد البرمجي الذي تستعمله يمكنك اضافته مباشرة الى مجلد مشروعك او تعديلها على حسب رغباتك (اذا كنت تستعمل مساعد برمجي مختلف عن GEMINI CLI غير اسم الملف الى آخر يناسب المساعد البرمجي الذي تستعمله)
